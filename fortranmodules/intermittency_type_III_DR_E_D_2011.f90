module intermittency_type_III_DR_E_D_2011
    ...
    !=======================================================
    ! Type III intermittency functions to be applied
    ! for the map of the paper:
    ! "Reinjection probability density in type-III intermittency"
    ! written by Elaskar, Del Río, Donoso - 2011
    ! The map being: xn+1 = -(1 + eps)xn - axn^3 + d*xn^6sin(xn)
    !-------------------------------------------------------
    ...
    function laminar_prob(l, xi, alfa, c, a, eps)
        use precision
        implicit none

        real(dp), intent(in)    :: l, xi, alfa, c, a, eps
        real(dp)                :: laminar_prob, x, b
