program heyl_double_pendulum
    ...
    real(dp),       parameter   :: ti=0._dp, tf=400._dp
    integer(sp),    parameter   :: dim_theta1_0=2, dim_theta2_0=10
    ...
    integer(sp),    parameter   :: n=2048 ! points number to use in RK4 method
    ...
    do j=1,dim_theta1_0
        do i=1,dim_theta2_0
            call RK4_four_eq_flip(1_sp,n,ti,tf,theta1_0(j),theta2_0(i),omega1_0,omega2_0,t_flip(i,j),1_sp,1_sp)
            !if (i <= 10 .and. j <= 10) then
            !    write(*,*) i,j,theta1_0(j),theta2_0(i),t_flip(i,j)
            !endif
        end do
    end do
